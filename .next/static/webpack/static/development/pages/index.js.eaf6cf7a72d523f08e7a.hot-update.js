...
var ChartForCity = function ChartForCity(props) {
  ...
  var timeseries = new pondjs__WEBPACK_IMPORTED_MODULE_6__["TimeSeries"]({
    ...
    points: data.map(function (_ref) {
      ...
      return [pondjs__WEBPACK_IMPORTED_MODULE_6__["Index"].getIndexString("1d", new Date(d)), value];
    })
  });
  ...
  return __jsx("div", {
  ...
  }, props.city, ", ", props.state), __jsx(react_timeseries_charts__WEBPACK_IMPORTED_MODULE_5__["Resizable"], {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 29,
    ...
    timeRange: new pondjs__WEBPACK_IMPORTED_MODULE_6__["TimeRange"](moment__WEBPACK_IMPORTED_MODULE_7___default()().set('day', 1).set('month', 0), moment__WEBPACK_IMPORTED_MODULE_7___default()()),
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 30,
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 6:
          ...
          max = Math.max(table.map(function (e) {
            return e[4];
          }));
...
//# sourceMappingURL=index.js.eaf6cf7a72d523f08e7a.hot-update.js.map