...
var ChartForCity = function ChartForCity(props) {
  ...
  var timeseries = new pondjs__WEBPACK_IMPORTED_MODULE_7__["TimeSeries"]({
    ...
    points: data.map(function (_ref) {
      ...
      return [pondjs__WEBPACK_IMPORTED_MODULE_7__["Index"].getIndexString("1d", new Date(d)), value / millions];
    })
  });
  ...
  }, todayCount, " (", rounded > 0 ? '+' : '', rounded, "%) total today"), __jsx("div", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 64,
  ...
  }, Math.round(todayCountPer * 1000) / 1000, " per million people"));
};
...
//# sourceMappingURL=index.js.33e1451178a2f6b2c62f.hot-update.js.map